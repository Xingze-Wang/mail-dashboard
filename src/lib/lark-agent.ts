...
async function runAgent(session: LarkSession, question: string, history: { role: "user" | "assistant"; text: string }[]): Promise<{ text: string; toolCallCount: number; toolNames: string[] }> {
